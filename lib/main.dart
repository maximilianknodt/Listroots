  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: ThemeData(
          ...
          primarySwatch: buildMaterialColor(const Color(0xFF5F9220)),
          primaryColor: const Color(0xFF5F9220),
          canvasColor: const Color(0xFFFDFEFC),
          backgroundColor: const Color(0xFFF5F5F4),
          cardColor: const Color(0XFFEBEBEA), //Primary-Container
      ...
      darkTheme: ThemeData(
        ...
        primarySwatch: buildMaterialColor(const Color(0xFF5F9220)),
        primaryColor: const Color(0xFF5F9220),
        canvasColor: const Color(0xFF1F221A),
        backgroundColor: const Color(0xFF141611),
        cardColor: const Color(0xFF29341D),
        fontFamily: 'IBM Plex Sans',
      ),
